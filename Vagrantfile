...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "cloud-native-box" do |vm1|
      config.ssh.private_key_path = "/Users/aungkohtet/Desktop/cloud-native-box/.ssh/id_rsa"
      config.ssh.forward_agent = true
      config.ssh.username = "vagrant"
      config.ssh.password = "vagrant"
      vm1.vm.hostname = "cloud-native-box"
      ...
      vm1.vm.provision "shell", run: "always", inline: <<-SHELL
        ...
        netstat -tunlp
        echo "Hello from cloud-native-box"
      SHELL
